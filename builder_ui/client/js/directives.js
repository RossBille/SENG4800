                ...
                drop: function (event, ui) {
                    ...
                    if ($draggable_parent_parent.hasClass('object-list')) {
                        ...
                        if (scope.objects[draggable_original_index].shape === 'circle') {
                            $new_object.attr('height', (scope.objects[draggable_original_index].radius * 2) / scope.canvas.multiplier);
                        }
                        else if (scope.objects[draggable_original_index].shape === 'rectangle') {
                            $new_object.attr('width', scope.objects[draggable_original_index].width / scope.canvas.multiplier);
                            $new_object.attr('height', scope.objects[draggable_original_index].height / scope.canvas.multiplier);
                        }
                        ...
                        if (scope.objects[draggable_original_index].shape === 'circle') {
                            new_scene_object.object_shape = {
                                circle: {
                                    radius: scope.objects[draggable_original_index].radius
                                }
                            }
                        }
                        else if (scope.objects[draggable_original_index].shape === 'rectangle') {
                            new_scene_object.object_shape = {
                                rectangle: {
                                    size: {
                                        width: scope.objects[draggable_original_index].width,
                                        height: scope.objects[draggable_original_index].height
                                    }
                                }
                            }
                        }
