 ...
 */
package au.edu.newcastle.SENG48002013.game.engine.resources.events;

import au.edu.newcastle.SENG48002013.game.engine.resources.environment.Circle;
import au.edu.newcastle.SENG48002013.game.engine.resources.environment.GameObject;
import au.edu.newcastle.SENG48002013.game.engine.resources.environment.Rectangle;
					...
					object1.getNextPos().y + object1Size.y > object2.getPos().y)
			{
				...
				if(!allowOverlap)
				{
					...
					else
					{
						...
						Vector2d shift = object1.getPos().difference(object1.getNextPos()).unit().scalarMul1(length);
