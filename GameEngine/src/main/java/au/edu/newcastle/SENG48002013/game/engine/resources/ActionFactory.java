...
public class ActionFactory {
    ...
    private static BaseAction buildChangeScoreAction(Element changeScoreElement, long id) {
        ...
        switch (strType.toUpperCase()) {
            case "ADD":
                action.setType(ChangeScoreAction.Type.ADD);
                break;
            case "SUB":
                action.setType(ChangeScoreAction.Type.SUB);
                break;
            case "SET":
                action.setType(ChangeScoreAction.Type.SET);
                break;
        }
        return action;
    }
    ...
    private static BaseAction buildChangeComponentAction(Element changeComponentElement, long id) {
        ...
        switch (strComponent.toUpperCase()) {
            case "POS":
                action.setComponent(ChangeComponentAction.Component.POS);
                break;
            case "VEL":
                action.setComponent(ChangeComponentAction.Component.VEL);
                break;
            case "ACC":
                action.setComponent(ChangeComponentAction.Component.ACC);
                break;
        }
        //Set the type
        ...
        switch (strType.toUpperCase()) {
            case "ADD":
                action.setType(ChangeComponentAction.Type.ADD);
                break;
            case "SUB":
                action.setType(ChangeComponentAction.Type.SUB);
                break;
            case "SET":
                action.setType(ChangeComponentAction.Type.SET);
                break;
        }
        return action;
    }
    ...
    private static BaseAction buildInputAction(Element inputElement, long id) {
        ...
        switch (strType.toUpperCase()) {
            case "ADD":
                action.setType(InputAction.Type.ADD);
                break;
            case "SUB":
                action.setType(InputAction.Type.SUB);
                break;
            case "SET":
                action.setType(InputAction.Type.SET);
                break;
        }
        return action;
    }
