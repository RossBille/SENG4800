...
/**
 * this class opens endpoints to accept all instructions and set up players and actions to send to the game engine
 * This endpoint needs to be accessed publicly 
 * @author Ross Bille
 */
...
public class InputEndpoint {
    ...
    public String onMessage(String message) {
        ...
        try {
            ...
            System.out.println(instruction.getMagnitude());
